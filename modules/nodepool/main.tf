...
# Instead of creating a security group, use the one defined in nodepool_security_group_id
...
resource "aws_launch_template" "this" {
  ...
  vpc_security_group_ids = concat([var.nodepool_security_group_id], var.vpc_security_group_ids)
