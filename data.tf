...
module "init" {
  source        = "git::https://repo1.dso.mil/platform-one/distros/rancher-federal/rke2/rke2-aws-terraform.git//modules/userdata?ref=v2.1.0"
  server_url    = local.cluster_data.server_url
